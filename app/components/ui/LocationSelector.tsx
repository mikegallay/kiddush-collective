...
const MyLocationSelector = (
    ({ label, id, description, onChange, options, formProps, ...props }: LocationProps) => {
        ...
        <div className="flex flex-col w-full gap-2">
          ...
          <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="w-[400px] p-0" align="start">
              <StatusList setOpen={setOpen} setSelectedStatus={setSelectedStatus} id={id} formProps={formProps} />
            </PopoverContent>
          </Popover>
...
function StatusList({
  ...
  return (
    <Command>
      <CommandInput placeholder="Filter Location List..."/>
      <CommandList>
