...
export default {
  ...
  upload: {
    ...
    recordAudioButton: "Quiero grabar audio",
    recordRemove: "Eliminar grabación",
    recordAudioCancel: "Cancelar",
    recordAudioDeleteCancel: "Eliminar y cancelar",
    recordAudioAccept: "Aceptar",
    recordAudioStart: "Iniciar grabación",
    recordAudioStop: "Detener grabación",
    recordAudioRerecord: "Regrabar",
